...
class ChickenProductView extends StatefulWidget {
  const ChickenProductView({super.key});

  @override
  State<ChickenProductView> createState() => _ChickenProductViewState();
}

class _ChickenProductViewState extends State<ChickenProductView> {
                  ...
                  onTap: () async {
                    http.Response res = await http.post(Uri.parse(""),
                        ...
                        body: jsonEncode({
                          "products": [
                            {
                              "productId": "64bfad4fdc9ba4145a1b16aa",
                              "quantity": 1
                            }
                          ],
                          "shippingAmount": 225,
                          "taxAmount": 0,
                          "instruction":
                              "Please customize the product as per my specifications"
                        }));
